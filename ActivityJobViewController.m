...
@implementation ActivityJobViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ActivityJobCell *cell = [tableView dequeueReusableCellWithIdentifier:cellName];
    if (cell==nil) {
        cell = [[ActivityJobCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellName];
    }
