...
#import "TextlineViewController.h"
#import "ZXMacro.h"
#import "DWinUtils.h"
#import <QuartzCore/QuartzCore.h>
#import "TextlineCell.h"
@interface TextlineViewController ()

@end

@implementation TextlineViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TextlineCell *cell = [tableView dequeueReusableCellWithIdentifier:cellName];
    if (cell==nil) {
        cell = [[TextlineCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellName];
    }
