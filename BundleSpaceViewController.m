...
@interface BundleSpaceViewController ()

@end

@implementation BundleSpaceViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"Budle space";
    ...
    UILabel *label_sex = [DWinUtils createLabelForAutoSize:CGPointMake(84, 41) WithContent:@"male" WithFontSize:10 WithFontKind:HELVETICANEUE_LIGHT WithTextColor:[UIColor colorWithRed:1 green:47.0/255 blue:227/255.0 alpha:1]];
