...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        d=[Singel danli];
        d.threepicArr=[[NSArray alloc]init];
        cutFlag=0;
    }
    return self;
}
-(void)change_titlePic:(UIButton*)sender
{
    if (sender.tag-10000==0)
    {
        ...
        [((UIButton*)[title_view viewWithTag:10000]) setBackgroundImage:[UIImage imageNamed:@"line_cube_clic"] forState:UIControlStateNormal];
        [((UIButton*)[title_view viewWithTag:10001]) setBackgroundImage:[UIImage imageNamed:@"line_cube_unclic2"] forState:UIControlStateNormal];
        [((UIButton*)[title_view viewWithTag:10002]) setBackgroundImage:[UIImage imageNamed:@"line_cube_unclic3"] forState:UIControlStateNormal];
    ...
    {
        cutFlag=1;
        [((UIButton*)[title_view viewWithTag:10000])setBackgroundImage:[UIImage imageNamed:@"line_cube_unclic"] forState:UIControlStateNormal];
        
        [((UIButton*)[title_view viewWithTag:10001] )setBackgroundImage:[UIImage imageNamed:@"line_cube_clic2"] forState:UIControlStateNormal];
        ...
        [toltle_scroll setHidden:NO];
                ...
                static float a=0;
        //循环向滑动视图上添加img
        for (int i =0; i<[d.threepicArr count]; i++)
            
        {
        
             UIImage *p=[d.threepicArr objectAtIndex:i];
            ...
            img.image = [d.threepicArr objectAtIndex:i];
            
            [toltle_scroll addSubview: img];
            if (i==[d.threepicArr count]-1)
            {
                 cutnum_w=a+cutnum_w;
                a=0;
    ...
    if (sender.tag-10000==2)
    {
        ...
        [((UIButton*)[title_view viewWithTag:10000])  setBackgroundImage:[UIImage imageNamed:@"line_cube_unclic"] forState:UIControlStateNormal];
        [((UIButton*)[title_view viewWithTag:10001] )setBackgroundImage:[UIImage imageNamed:@"line_cube_unclic2"] forState:UIControlStateNormal];
        [((UIButton*)[title_view viewWithTag:10002] ) setBackgroundImage:[UIImage imageNamed:@"line_cube_clic3"] forState:UIControlStateNormal];
...
- (void)viewDidLoad
{
   ...
   titile_picArr = [[NSArray alloc]initWithObjects:@"line_cube_clic",@"line_cube_unclic2",@"line_cube_unclic3", nil];
    ...
    click_arr=[[NSArray alloc]initWithObjects:@"1111",@"222",@"333",@"444", @"555",@"666",nil];
    //未点击的
     unclick_arr=[[NSArray alloc]initWithObjects:@"111",@"2222",@"3333",@"4444", @"5555",@"6666",nil];
   ...
   for (int i = 0; i<6; i++) {
        ...
        pic_btn.tag = 1000+i;
        [pic_btn setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:i]] forState:UIControlStateNormal];
    ...
    toltle_scroll = [[UIScrollView alloc]initWithFrame:CGRectMake(0,100, 320,200)];
    toltle_scroll.backgroundColor = [UIColor whiteColor];
    toltle_scroll.contentSize = CGSizeMake([d.threepicArr count]*200+100, 200);
...
-(void)change_pic:(UIButton*)sender
{
    ...
    {
        [(UIButton*)[self.view viewWithTag:1000] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:0]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1001] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:1]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1002] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:2]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1003] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:3]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1004] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:4]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1005] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:5]] forState:UIControlStateNormal];
        ...
        self.img.image=[d.threepicArr objectAtIndex:0];
        self.img1.image=[d.threepicArr objectAtIndex:1];
        self.img2.image=[d.threepicArr objectAtIndex:2];
       }
    if (sender.tag-1000==1)
    {
        [(UIButton*)[self.view viewWithTag:1000] setBackgroundImage:[UIImage imageNamed:[click_arr objectAtIndex:0]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1001] setBackgroundImage:[UIImage imageNamed:[click_arr objectAtIndex:1]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1002] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:2]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1003] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:3]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1004] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:4]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1005] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:5]] forState:UIControlStateNormal];
        ...
        self.img.userInteractionEnabled = YES;
        [back_view1 addSubview:self.img];
        self.img1=[[UIImageView alloc]initWithFrame:CGRectMake(2, (318+4)/2+2, 294/2, 320/2-2)];
        self.img1.tag=10002;
              [back_view1 addSubview:self.img1];
        
              self.img2=[[UIImageView alloc]initWithFrame:CGRectMake(298/2+2, 2, 294/2, 642/2-2)];
        self.img2.tag=10003;
    ...
    if (sender.tag-1000==2)
    {
        [(UIButton*)[self.view viewWithTag:1000] setBackgroundImage:[UIImage imageNamed:[click_arr objectAtIndex:0]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1001] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:1]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1002] setBackgroundImage:[UIImage imageNamed:[click_arr objectAtIndex:2]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1003] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:3]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1004] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:4]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1005] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:5]] forState:UIControlStateNormal];
        ...
        self.img=[[UIImageView alloc]initWithFrame:CGRectMake(2, 142, 296, 179)];
        self.img.tag=10001;
             self. img.backgroundColor = [UIColor redColor];
        self.img.userInteractionEnabled = YES;
        [back_view1 addSubview:self.img];
        self.img1=[[UIImageView alloc]initWithFrame:CGRectMake(2, 2, 147, 138)];
        self.img1.tag=10002;
 
        [back_view1 addSubview:self.img1];
        
               self.img2=[[UIImageView alloc]initWithFrame:CGRectMake(151, 2, 147, 138)];
        self.img2.tag=10003;
    ...
    if (sender.tag-1000==3)
    {
        ...
        [(UIButton*)[self.view viewWithTag:1001] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:1]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1002] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:2]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1003] setBackgroundImage:[UIImage imageNamed:[click_arr objectAtIndex:3]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1004] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:4]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1005] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:5]] forState:UIControlStateNormal];
        ...
        self.img=[[UIImageView alloc]initWithFrame:CGRectMake(298/2+2, 2, 294/2, 318/2)];
        self.img.tag=10001;
              self. img.backgroundColor = [UIColor redColor];
        self.img.userInteractionEnabled = YES;
        [back_view1 addSubview:self.img];
        self.img1=[[UIImageView alloc]initWithFrame:CGRectMake(298/2+2, (318+4)/2+2, 294/2, 320/2-2)];
        self.img1.tag=10002;

        [back_view1 addSubview:self.img1];
        
     
        self.img2=[[UIImageView alloc]initWithFrame:CGRectMake(2, 2, 294/2, 642/2-2)];
        self.img2.tag=10003;
    ...
    if (sender.tag-1000==4)
    {
        ...
        [(UIButton*)[self.view viewWithTag:1002] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:2]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1003] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:3]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1004] setBackgroundImage:[UIImage imageNamed:[click_arr objectAtIndex:4]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1005] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:5]] forState:UIControlStateNormal];
        ...
        [[self.view viewWithTag:10003] removeFromSuperview];
          ...
          //  self.img1.image=[UIImage imageNamed:@"123"];
           ...
           // self.img2.image=[UIImage imageNamed:@"t"];
            ...
            self.img.frame  = CGRectMake(2, 2, back_view1.frame.size.width/3-8/3-6, back_view1.frame.size.height-2-2);
            self.img1.frame = CGRectMake(back_view1.frame.size.width/3-8/3-2, 2, back_view1.frame.size.height/3-8/3-6,back_view1.frame.size.height-2-2);
            self.img2.frame = CGRectMake(+back_view1.frame.size.width/3-8/3+2+back_view1.frame.size.width/3-8/3, 2, back_view1.frame.size.height/3-8/3-6, back_view1.frame.size.height-2-2);
        self.img.image=[d.threepicArr objectAtIndex:0];
        self.img1.image=[d.threepicArr objectAtIndex:1];
        self.img2.image=[d.threepicArr objectAtIndex:2];
    ...
    if (sender.tag-1000==5)
    {
        ...
        [(UIButton*)[self.view viewWithTag:1003] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:3]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1004] setBackgroundImage:[UIImage imageNamed:[unclick_arr objectAtIndex:4]] forState:UIControlStateNormal];
        [(UIButton*)[self.view viewWithTag:1005] setBackgroundImage:[UIImage imageNamed:[click_arr objectAtIndex:5]] forState:UIControlStateNormal];
           ...
           // self.img2.image=[UIImage imageNamed:@"t"];
            ...
            self.img.frame  = CGRectMake(2, 2, 296, back_view1.frame.size.height/3-8/3);
            self.img1.frame = CGRectMake(2, back_view1.frame.size.height/3-8/3+4, 296, back_view1.frame.size.height/3-8/3);
            self.img2.frame = CGRectMake(2, back_view1.frame.size.height/3-8/3+6+back_view1.frame.size.height/3-8/3, 296, back_view1.frame.size.height/3-8/3-2);
