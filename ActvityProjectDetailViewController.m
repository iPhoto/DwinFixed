//
//  ActvityProjectDetailViewController.m
//  DWin1.0
//
...
@interface ActvityProjectDetailViewController ()

@end

@implementation ActvityProjectDetailViewController
...
- (void)viewDidLoad
{
    ...
    lab_title0.text = @"Project: Make an App";
    lab_title1.text = @"Partner:";
    lab_title2.text = @"the project is very interesting ,we will make a new app ";
   ...
   // Partner.delegate =self;
    topic.text = @"I want a develerperment ";
    [topic setEnabled:NO];
    ...
    [edit_btn setTitle:@"Post" forState:UIControlStateNormal];
    [edit_btn
