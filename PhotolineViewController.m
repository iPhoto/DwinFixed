...
#import "PhotolineViewController.h"
#import "ZXMacro.h"
#import "DWinUtils.h"
#import <QuartzCore/QuartzCore.h>
#import "PhotolineCell.h"
@interface PhotolineViewController ()

@end

@implementation PhotolineViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PhotolineCell *cell = [tableView dequeueReusableCellWithIdentifier:cellName];
    if (cell==nil) {
        cell = [[PhotolineCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellName];
    }
