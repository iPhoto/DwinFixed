//
//  ActivityjobDetailViewController.m
//  DWin1.0
//
...
@interface ActivityjobDetailViewController ()

@end

@implementation ActivityjobDetailViewController
...
- (void)viewDidLoad
{
    ...
    lab_title2 = [[UILabel alloc]initWithFrame:CGRectMake(10, 0+50+69, 250, 60)];
    
    
    lab_title0.text = @"Job: Develooper";
    lab_title1.text = @"Salary:";
    lab_title2.text = @"1.Familiar to c++ html";
   ...
   // Partner.delegate =self;
    topic.text = @"2000RMB/Month";
    [topic setEnabled:NO];
    Partner.text = @"2.Describe the partner you need";
    //[topic setEnabled:NO];
...
//    [edit_btn setTitle:@"Chat" forState:UIControlStateNormal];
//    [edit_btn
//     setTitleColor:RGB(177, 255, 199) forState:UIControlStateNormal    ];
//    [edit_btn addTarget:self action:@selector(chat) forControlEvents:UIControlEventTouchUpInside];
...
//    
    ...
    for (int a = 0; a<4; a++) {
       ...
       UIButton *edit_btn = [UIButton buttonWithType:UIButtonTypeCustom];
        ...
        [edit_btn
         setTitleColor:RGB(177, 255, 199) forState:UIControlStateNormal    ];
       [edit_btn addTarget:self action:@selector(Post) forControlEvents:UIControlEventTouchUpInside];
       [back_View2 addSubview:edit_btn];
