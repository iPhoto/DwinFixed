//
//  MakeClasifiedSecondViewController.m
//  DWin1.0
//
...
@interface MakeClasifiedSecondViewController ()

@end

@implementation MakeClasifiedSecondViewController
...
-(void)chat
{
    ...
    for (int a = 0; a<2; a++)
    {
        ...
        btn.tag= 9000+a;
        if (a==0) {
            btn.frame = CGRectMake(260, 18, 16, 8);
            [btn setBackgroundImage:[UIImage imageWithContentsOfFile:FileS(@"activity_clasfied_up", @"png")] forState:UIControlStateNormal];
