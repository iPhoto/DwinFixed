...
@interface ActivityIdeaViewController ()

@end

@implementation ActivityIdeaViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ActivityIdeaCell *cell = [tableView dequeueReusableCellWithIdentifier:cellName];
    if (cell==nil) {
        cell = [[ActivityIdeaCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellName];
    }
