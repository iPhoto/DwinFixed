...
#import "Singel.h"
@interface AddFourViewController : UIViewController

{
  ...
  //  NSArray*pic_arr;
    ...
    int cutFlag;
     UIView *title_view;
    UIScrollView*scoro,*scoro1,*scoro2,*scoro3;
}


@property(nonatomic,strong) UIImageView*img,*img2,*img1,*img3;
