//
//  ActivityIdeaLineViewController.m
//  DWin1.0
//
...
@interface ActivityIdeaLineViewController ()

@end

@implementation ActivityIdeaLineViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ActivityIdeaLineCell *cell = [tableView dequeueReusableCellWithIdentifier:cellName];
    if (cell==nil) {
        cell = [[ActivityIdeaLineCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellName];
    }
